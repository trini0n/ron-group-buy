    ...
    <div class="flex items-center gap-2">
      ...
      {:else}
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Content align="end">
            <DropdownMenu.Item onclick={signInWithGoogle}>
            ...
            <DropdownMenu.Item onclick={signInWithDiscord}>
              <svg class="mr-2 h-4 w-4" viewBox="0 0 24 24">
      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Content align="end">
          <DropdownMenu.Item href="/">Cards</DropdownMenu.Item>
          <DropdownMenu.Item href="/deck-import">Deck Import</DropdownMenu.Item>
          {#if user}
            <DropdownMenu.Item href="/orders">Orders</DropdownMenu.Item>
          {/if}
        </DropdownMenu.Content>
      </DropdownMenu.Root>
    </div>
