...
<div class="container flex min-h-[80vh] items-center justify-center py-8">
  <Card.Root class="w-full max-w-md">
    <Card.Header class="text-center">
      ...
      <Card.Description>Sign in to your account to place orders</Card.Description>
    </Card.Header>
    ...
    <Card.Footer class="justify-center">
      <p class="text-sm text-muted-foreground">
        ...
        <a href="/auth/signup?next={encodeURIComponent(next)}" class="text-primary hover:underline">
          Sign up
        </a>
      </p>
    </Card.Footer>
