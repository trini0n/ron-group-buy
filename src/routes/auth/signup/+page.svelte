<script lang="ts">
  ...
  import { Check, X, Info, GalleryVerticalEnd } from 'lucide-svelte';
...
<div class="bg-background flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
  <div class="w-full max-w-sm">
    <div class="flex flex-col gap-6">
      ...
      {:else}
        <form onsubmit={handleSignup} class="flex flex-col gap-6">
          <!-- Header Section -->
          <div class="flex flex-col items-center gap-2 text-center">
            ...
            <p class="text-sm text-muted-foreground">
              Already have an account? <a href="/auth/login?next={encodeURIComponent(next)}" class="underline underline-offset-4 hover:text-primary">Sign in</a>
            </p>
          </div>
